...
<template>
  ...
  >
    <div class="container-xl text-start">
      <strong>New Feature!</strong> DawgPath has new data to help you plan a balanced
      schedule. Search for a Seattle course to get a walk through of the
      <strong>Course Outcome Index</strong>. Coming soon for Bothell and Tacoma.
