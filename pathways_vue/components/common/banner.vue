...
<template>
    ...
    <div class="alert alert-info alert-dismissible fade show text-center mb-0" v-if="show_bottleneck">
        <strong>New Feature!</strong> DawgPath now shows which courses act as a gateway course for easier
        registration planning. <a href="/faq#gateway" class="router-link">Learn more.</a>
